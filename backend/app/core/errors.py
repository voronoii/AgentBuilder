...
class ErrorCode(StrEnum):
    ...
    MCP_OAUTH_DISCOVERY_FAILED = "MCP_OAUTH_DISCOVERY_FAILED"
    MCP_OAUTH_REGISTRATION_FAILED = "MCP_OAUTH_REGISTRATION_FAILED"
    MCP_OAUTH_TOKEN_FAILED = "MCP_OAUTH_TOKEN_FAILED"
    MCP_OAUTH_NOT_CONFIGURED = "MCP_OAUTH_NOT_CONFIGURED"
    MCP_OAUTH_INVALID_STATE = "MCP_OAUTH_INVALID_STATE"
    # Workflow
